...
% Look at Single target accuracy
 ...
 single_indexes_correct=zeros(1, length(single_index));
   ...
   %% From double stimulus presentation select all three categories BOTH; ONE; NONE 
...
%% Geting the triggers
   ...
   clear double_50_20 double_80_50 double_50_50
...
% TODO -remove the noisy triggers 
